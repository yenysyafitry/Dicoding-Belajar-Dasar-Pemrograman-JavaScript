...
<ul align="justify"><li> Undefined </br>
...
<b>Fungsi typeof()</b> digunakan untuk memastikan tipe data pada variabel dengan mengembalikan tipe data tersebut dalam bentuk teks.
```plantuml
