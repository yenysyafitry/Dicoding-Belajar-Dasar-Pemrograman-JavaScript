```diff
+ <b>Compiler</b> adalah Program komputer yang menerjemahkan kode yang ditulis dalam satu bahasa pemrograman ke bahasa lain yang dimengerti oleh mesin.
...
+ String Concatenation adalah Proses penggabungan dua String atau lebih menggunakan operator penjumlahan (+).
